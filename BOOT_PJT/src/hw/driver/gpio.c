...
gpio_tbl_t gpio_tbl[GPIO_MAX_CH] =
{
		...
		{GPIOA , GPIO_PIN_1 , _DEF_OUTPUT       ,GPIO_PIN_SET  , GPIO_PIN_RESET, _DEF_HIGH },   // RTU // MAX 485 CS
		{GPIOB , GPIO_PIN_12 , _DEF_OUTPUT      ,GPIO_PIN_SET  , GPIO_PIN_RESET, _DEF_HIGH }    // CLI // MAX 485 CS
